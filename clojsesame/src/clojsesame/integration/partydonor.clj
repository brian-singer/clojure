...
(def donorIcoURI (createURI (str basicNamespace "/donorIco")))
(def donorCompanyURI (createURI (str basicNamespace "/donorCompany")))
(def acceptDateURI (createURI (str basicNamespace "/acceptDate")))

(def partydonorMap { 
	:name fullname
	:donorCompany donorCompanyURI
	:donorIco donorIcoURI
	:amount amount
	:currency currency 
	:address address
	:city city
